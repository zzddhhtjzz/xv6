...
void child(void *arg)
{
  ...
  pthread_mutex_lock(&mutex);
   6:	c7 04 24 20 10 00 00 	movl   $0x1020,(%esp)
   d:	e8 c8 09 00 00       	call   9da <pthread_mutex_lock>
  printf(1, "child starts\n");
  12:	c7 44 24 04 a4 0b 00 	movl   $0xba4,0x4(%esp)
  19:	00 
  1a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  21:	e8 0a 05 00 00       	call   530 <printf>
  done = 1;
  26:	c7 05 08 10 00 00 01 	movl   $0x1,0x1008
  2d:	00 00 00 
  pthread_cond_signal(&cond);
  30:	c7 04 24 18 10 00 00 	movl   $0x1018,(%esp)
  37:	e8 80 0a 00 00       	call   abc <pthread_cond_signal>
  printf(1, "child ends\n");
  3c:	c7 44 24 04 b2 0b 00 	movl   $0xbb2,0x4(%esp)
  43:	00 
  44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  4b:	e8 e0 04 00 00       	call   530 <printf>
  pthread_mutex_unlock(&mutex);
  50:	c7 04 24 20 10 00 00 	movl   $0x1020,(%esp)
  57:	e8 9f 09 00 00       	call   9fb <pthread_mutex_unlock>
  exit();
  5c:	e8 27 03 00 00       	call   388 <exit>
...
int main(){
  ...
  6a:	c7 44 24 04 be 0b 00 	movl   $0xbbe,0x4(%esp)
  71:	00 
  72:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  79:	e8 b2 04 00 00       	call   530 <printf>
  pthread_mutex_init(&mutex);
  7e:	c7 04 24 20 10 00 00 	movl   $0x1020,(%esp)
  85:	e8 41 09 00 00       	call   9cb <pthread_mutex_init>
  pthread_cond_init(&cond);
  8a:	c7 04 24 18 10 00 00 	movl   $0x1018,(%esp)
  91:	e8 81 09 00 00       	call   a17 <pthread_cond_init>
  mpthread_t p;
  pthread_create(&p, NULL, child,(void*)NULL);
  96:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  9d:	00 
  9e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  a5:	00 
  a6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  ad:	00 
  ae:	8d 44 24 1c          	lea    0x1c(%esp),%eax
  b2:	89 04 24             	mov    %eax,(%esp)
  b5:	e8 60 08 00 00       	call   91a <pthread_create>
  
  pthread_mutex_lock(&mutex);
  ba:	c7 04 24 20 10 00 00 	movl   $0x1020,(%esp)
  c1:	e8 14 09 00 00       	call   9da <pthread_mutex_lock>
  while(!done)
  c6:	eb 14                	jmp    dc <main+0x7b>
    pthread_cond_wait(&cond, &mutex);
  c8:	c7 44 24 04 20 10 00 	movl   $0x1020,0x4(%esp)
  cf:	00 
  d0:	c7 04 24 18 10 00 00 	movl   $0x1018,(%esp)
  d7:	e8 54 09 00 00       	call   a30 <pthread_cond_wait>
  pthread_cond_init(&cond);
  mpthread_t p;
  pthread_create(&p, NULL, child,(void*)NULL);
  ...
  pthread_mutex_lock(&mutex);
  while(!done)
  dc:	a1 08 10 00 00       	mov    0x1008,%eax
  e1:	85 c0                	test   %eax,%eax
  e3:	74 e3                	je     c8 <main+0x67>
    pthread_cond_wait(&cond, &mutex);
  pthread_mutex_unlock(&mutex);
  e5:	c7 04 24 20 10 00 00 	movl   $0x1020,(%esp)
  ec:	e8 0a 09 00 00       	call   9fb <pthread_mutex_unlock>
  pthread_join(p, NULL);
  f1:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  f5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  fc:	00 
  fd:	89 04 24             	mov    %eax,(%esp)
 100:	e8 91 08 00 00       	call   996 <pthread_join>
  
  printf(1, "parent finished\n");
 105:	c7 44 24 04 cc 0b 00 	movl   $0xbcc,0x4(%esp)
 10c:	00 
 10d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 114:	e8 17 04 00 00       	call   530 <printf>
  exit();
 119:	e8 6a 02 00 00       	call   388 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c9:	0f b6 80 f4 0f 00 00 	movzbl 0xff4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 626:	75 09                	jne    631 <printf+0x101>
          s = "(null)";
 628:	c7 45 f4 dd 0b 00 00 	movl   $0xbdd,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f3:	a1 14 10 00 00       	mov    0x1014,%eax
...
free(void *ap)
{
 ...
 7be:	a3 14 10 00 00       	mov    %eax,0x1014
}
 7c3:	c9                   	leave  
 7c4:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 811:	e8 ce fe ff ff       	call   6e4 <free>
  return freep;
 816:	a1 14 10 00 00       	mov    0x1014,%eax
}
 81b:	c9                   	leave  
 81c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 82f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 832:	a1 14 10 00 00       	mov    0x1014,%eax
 837:	89 45 f0             	mov    %eax,-0x10(%ebp)
 83a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 83e:	75 23                	jne    863 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 840:	c7 45 f0 0c 10 00 00 	movl   $0x100c,-0x10(%ebp)
 847:	8b 45 f0             	mov    -0x10(%ebp),%eax
 84a:	a3 14 10 00 00       	mov    %eax,0x1014
 84f:	a1 14 10 00 00       	mov    0x1014,%eax
 854:	a3 0c 10 00 00       	mov    %eax,0x100c
    base.s.size = 0;
 859:	c7 05 10 10 00 00 00 	movl   $0x0,0x1010
 860:	00 00 00 
  }
 ...
 8b6:	a3 14 10 00 00       	mov    %eax,0x1014
      return (void*)(p + 1);
 ...
 8c1:	eb 38                	jmp    8fb <malloc+0xde>
    ...
    if(p == freep)
 8c3:	a1 14 10 00 00       	mov    0x1014,%eax
...
int pthread_create(mpthread_t *thread, mpthread_attr_t *attr, void(*func)(void*), void*arg){
 ...
 936:	c7 44 24 04 e4 0b 00 	movl   $0xbe4,0x4(%esp)
 93d:	00 
