...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 2b 0b 00 	movl   $0xb2b,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 439:	0f b6 80 44 0f 00 00 	movzbl 0xf44(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 596:	75 09                	jne    5a1 <printf+0x101>
          s = "(null)";
 598:	c7 45 f4 47 0b 00 00 	movl   $0xb47,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 663:	a1 60 0f 00 00       	mov    0xf60,%eax
...
free(void *ap)
{
 ...
 72e:	a3 60 0f 00 00       	mov    %eax,0xf60
}
 733:	c9                   	leave  
 734:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 781:	e8 ce fe ff ff       	call   654 <free>
  return freep;
 786:	a1 60 0f 00 00       	mov    0xf60,%eax
}
 78b:	c9                   	leave  
 78c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 79f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7a2:	a1 60 0f 00 00       	mov    0xf60,%eax
 7a7:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7aa:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7ae:	75 23                	jne    7d3 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 45 f0 58 0f 00 00 	movl   $0xf58,-0x10(%ebp)
 7b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7ba:	a3 60 0f 00 00       	mov    %eax,0xf60
 7bf:	a1 60 0f 00 00       	mov    0xf60,%eax
 7c4:	a3 58 0f 00 00       	mov    %eax,0xf58
    base.s.size = 0;
 7c9:	c7 05 5c 0f 00 00 00 	movl   $0x0,0xf5c
 7d0:	00 00 00 
  }
 ...
 826:	a3 60 0f 00 00       	mov    %eax,0xf60
      return (void*)(p + 1);
...
int pthread_create(mpthread_t *thread, mpthread_attr_t *attr, void(*func)(void*), void*arg){
 ...
 8a6:	c7 44 24 04 50 0b 00 	movl   $0xb50,0x4(%esp)
 8ad:	00 
